...
REGISTRY_PATH = DATA_DIR / "chunk_registry.json"
...
DEFAULT_RETRIEVAL_K = int(os.getenv("RABBOOK_RETRIEVAL_K", "6"))
DEFAULT_RERANK_CANDIDATE_K = int(os.getenv("RABBOOK_RERANK_CANDIDATE_K", "40"))
DEFAULT_BM25_CANDIDATE_K = int(os.getenv("RABBOOK_BM25_CANDIDATE_K", "40"))
...
ENABLE_TOOL_AGENT = os.getenv("RABBOOK_ENABLE_TOOL_AGENT", "false").lower() == "true"
